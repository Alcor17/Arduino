...
//write in n Displays, beginning at pos (0 is the MSB) the string named character
...
//Shifts to right the string n times with a t delay
...
//Shifts to left the string n times with a t delay
